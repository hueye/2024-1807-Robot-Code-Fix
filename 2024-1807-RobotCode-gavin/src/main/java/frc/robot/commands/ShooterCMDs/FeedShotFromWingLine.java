...
public class FeedShotFromWingLine extends Command {
  private Shooter shooterSubsystem;
  /** Creates a new ManShootCurrentAngle. */
  public FeedShotFromWingLine(Shooter shooterSubsystem) {
  ...
  public void initialize() {
    ...
    shooterSubsystem.setFlywheelsRPM(ShooterConstants.feedingWingRPM);
  }
