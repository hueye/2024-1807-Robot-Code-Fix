...
public class SelfPodiumShotCMD extends SequentialCommandGroup {
  /** Creates a new ShootAnywhereCMD. */
  public SelfPodiumShotCMD(Shooter shooterSubsystem, CommandXboxController controller, DriveTrain driveTrain, Vision visionSubsystem) {
