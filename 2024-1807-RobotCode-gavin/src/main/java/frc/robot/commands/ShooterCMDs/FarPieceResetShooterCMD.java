...
public class FarPieceResetShooterCMD extends SequentialCommandGroup {
  /** Creates a new ResetShooterCMD. */
  public FarPieceResetShooterCMD(Shooter shooterSubsystem) {
    ...
    addCommands(
      ...
      new SetPivotAngleCMD(25, shooterSubsystem));
  }
}
